...
export const BESTIARY=[
  ...
  ...Object.entries(EXTRA_ENEMIES).map(([id,e])=>[e.name,{charger:'直線蓄力衝撞，橫向移動閃避。',spitter:'在你的位置噴灑持續毒池。',summoner:'召喚奔行獸，優先擊殺可降低壓力。',wraith:'穿越地形追蹤，但攻擊前仍會停頓。',frostBoss:'冰彈扇射與延遲冰爆，半血後加速。',broodBoss:'召喚護衛、散布毒池與環形毒彈。'}[id]]),
...
export function startExtraAttack(e,dist){return e.type==='charger'?dist<370:e.type==='spitter'?dist<420:e.type==='summoner'?dist<600:isBoss(e)?dist<720:false}
